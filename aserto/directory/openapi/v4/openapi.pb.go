...
// 	protoc        (unknown)
// source: aserto/directory/openapi/v4/openapi.proto
...
var File_aserto_directory_openapi_v4_openapi_proto protoreflect.FileDescriptor
...
func init() { file_aserto_directory_openapi_v4_openapi_proto_init() }
func file_aserto_directory_openapi_v4_openapi_proto_init() {
	if File_aserto_directory_openapi_v4_openapi_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_aserto_directory_openapi_v4_openapi_proto_rawDesc), len(file_aserto_directory_openapi_v4_openapi_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_aserto_directory_openapi_v4_openapi_proto_goTypes,
		DependencyIndexes: file_aserto_directory_openapi_v4_openapi_proto_depIdxs,
	}.Build()
	File_aserto_directory_openapi_v4_openapi_proto = out.File
	file_aserto_directory_openapi_v4_openapi_proto_goTypes = nil
	file_aserto_directory_openapi_v4_openapi_proto_depIdxs = nil
}
