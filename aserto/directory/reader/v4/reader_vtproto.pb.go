...
func (m *GetRelationsRequest) CloneVT() *GetRelationsRequest {
	...
	if rhs := m.Param; rhs != nil {
		tmpContainer := make([]*v4.RelationIdentifier, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.Param = tmpContainer
...
func (this *GetRelationsRequest) EqualVT(that *GetRelationsRequest) bool {
	...
	for i, vx := range this.Param {
		...
		if p, q := vx, vy; p != q {
			if p == nil {
				p = &v4.RelationIdentifier{}
			}
			if q == nil {
				q = &v4.RelationIdentifier{}
			}
			if !p.EqualVT(q) {
				return false
			}
...
func (m *GetObjectsRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Param = append(m.Param, &v4.ObjectIdentifier{})
...
func (m *GetRelationsRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Param = append(m.Param, &v4.RelationIdentifier{})
			if err := m.Param[len(m.Param)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
