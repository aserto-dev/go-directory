...
func (c *exporterClient) Export(ctx context.Context, in *ExportRequest, opts ...grpc.CallOption) (Exporter_ExportClient, error) {
	stream, err := c.cc.NewStream(ctx, &Exporter_ServiceDesc.Streams[0], "/aserto.directory.exporter.v3.Exporter/Export", opts...)
	if err != nil {
		return nil, err
	}
...
func (m *ExportRequest) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.StartFrom != nil {
		size, err := (*timestamppb1.Timestamp)(m.StartFrom).MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *ExportResponse) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if msg, ok := m.Msg.(*ExportResponse_Stats); ok {
	...
	if msg, ok := m.Msg.(*ExportResponse_Relation); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
	...
	if msg, ok := m.Msg.(*ExportResponse_Object); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
...
func (m *ExportResponse_Object) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *ExportResponse_Object) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Object != nil {
...
func (m *ExportResponse_Relation) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *ExportResponse_Relation) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Relation != nil {
...
func (m *ExportResponse_Stats) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *ExportResponse_Stats) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Stats != nil {
		size, err := (*structpb1.Struct)(m.Stats).MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *ExportRequest) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			...
			if err := (*timestamppb1.Timestamp)(m.StartFrom).UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ExportResponse) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if oneof, ok := m.Msg.(*ExportResponse_Stats); ok {
				if err := (*structpb1.Struct)(oneof.Stats).UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &structpb.Struct{}
