...
var file_aserto_directory_common_v3_common_proto_rawDesc = []byte{
	...
	0x22, 0x23, 0x0a, 0x02, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x07, 0xba, 0x48, 0x04, 0x7a, 0x02, 0x18, 0x10, 0x52, 0x05,
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x46, 0x5a, 0x44, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_aserto_directory_common_v3_common_proto_goTypes = []any{
	...
	(*Id)(nil),                    // 6: aserto.directory.common.v3.Id
...
func file_aserto_directory_common_v3_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_aserto_directory_common_v3_common_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*Id); i {
			case 0:
				return &v.state
			case 1:
