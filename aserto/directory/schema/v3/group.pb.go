...
var file_aserto_directory_schema_v3_group_proto_rawDesc = []byte{
	0x0a, 0x26, 0x61, 0x73, 0x65, 0x72, 0x74, 0x6f, 0x2f, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f,
	0x72, 0x79, 0x2f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2f, 0x76, 0x33, 0x2f, 0x67, 0x72, 0x6f,
	...
	0x61, 0x2e, 0x76, 0x33, 0x22, 0x36, 0x0a, 0x0f, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x50, 0x72, 0x6f,
...
var (
	...
	file_aserto_directory_schema_v3_group_proto_rawDescData = file_aserto_directory_schema_v3_group_proto_rawDesc
)
...
func file_aserto_directory_schema_v3_group_proto_rawDescGZIP() []byte {
	file_aserto_directory_schema_v3_group_proto_rawDescOnce.Do(func() {
		file_aserto_directory_schema_v3_group_proto_rawDescData = protoimpl.X.CompressGZIP(file_aserto_directory_schema_v3_group_proto_rawDescData)
	})
...
var file_aserto_directory_schema_v3_group_proto_goTypes = []interface{}{
...
func file_aserto_directory_schema_v3_group_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_aserto_directory_schema_v3_group_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_aserto_directory_schema_v3_group_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_aserto_directory_schema_v3_group_proto_rawDesc = nil
