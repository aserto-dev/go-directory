...
//
// Deprecated: Marked as deprecated in aserto/directory/schema/v3/user.proto.
...
const file_aserto_directory_schema_v3_user_proto_rawDesc = "" +
	"\n" +
	"%aserto/directory/schema/v3/user.proto\x12\x1aaserto.directory.schema.v3\"\xc3\x01\n" +
	...
	"\rconnection_id\x18\x05 \x01(\tR\fconnectionId:\x02\x18\x01*\x84\x02\n" +
	"\n" +
	"UserStatus\x12\x17\n" +
