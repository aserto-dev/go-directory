...
func request_Importer_Import_0(ctx context.Context, marshaler runtime.Marshaler, client ImporterClient, req *http.Request, pathParams map[string]string) (Importer_ImportClient, runtime.ServerMetadata, error) {
...
// "ImporterClient" to call the correct interceptors.
func RegisterImporterHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ImporterClient) error {
	...
	mux.Handle("POST", pattern_Importer_Import_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/aserto.directory.importer.v2.Importer/Import", runtime.WithHTTPPathPattern("/aserto.directory.importer.v2.Importer/Import"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Importer_Import_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Importer_Import_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Importer_Import_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"aserto.directory.importer.v2.Importer", "Import"}, ""))
)
