...
func (m *ImportRequest_Model) CloneVT() isImportRequest_Msg {
	if m == nil {
		return (*ImportRequest_Model)(nil)
	}
	r := new(ImportRequest_Model)
...
func (m *ImportResponse_Manifest) CloneVT() isImportResponse_Msg {
	if m == nil {
		return (*ImportResponse_Manifest)(nil)
	}
	r := new(ImportResponse_Manifest)
	r.Manifest = m.Manifest.CloneVT()
	return r
}

func (m *ImportResponse_Model) CloneVT() isImportResponse_Msg {
	if m == nil {
		return (*ImportResponse_Model)(nil)
	}
	r := new(ImportResponse_Model)
	r.Model = m.Model.CloneVT()
	return r
}

func (m *ImportResponse_Object) CloneVT() isImportResponse_Msg {
	if m == nil {
		return (*ImportResponse_Object)(nil)
	}
	r := new(ImportResponse_Object)
	r.Object = m.Object.CloneVT()
	return r
}

func (m *ImportResponse_Relation) CloneVT() isImportResponse_Msg {
	if m == nil {
		return (*ImportResponse_Relation)(nil)
	}
	r := new(ImportResponse_Relation)
	r.Relation = m.Relation.CloneVT()
	return r
}
...
func (this *ImportRequest_Model) EqualVT(thatIface isImportRequest_Msg) bool {
	that, ok := thatIface.(*ImportRequest_Model)
	if !ok {
		return false
	}
	if this == that {
...
func (this *ImportResponse_Manifest) EqualVT(thatIface isImportResponse_Msg) bool {
	that, ok := thatIface.(*ImportResponse_Manifest)
	if !ok {
		return false
	}
	if this == that {
...
func (this *ImportResponse_Model) EqualVT(thatIface isImportResponse_Msg) bool {
	that, ok := thatIface.(*ImportResponse_Model)
	if !ok {
		return false
	}
	if this == that {
...
func (this *ImportResponse_Object) EqualVT(thatIface isImportResponse_Msg) bool {
	that, ok := thatIface.(*ImportResponse_Object)
	if !ok {
		return false
	}
	if this == that {
...
func (this *ImportResponse_Relation) EqualVT(thatIface isImportResponse_Msg) bool {
	that, ok := thatIface.(*ImportResponse_Relation)
	if !ok {
		return false
	}
	if this == that {
...
func (m *ImportRequest_Model) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ImportRequest_Model) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Model != nil {
...
func (m *ImportResponse_Manifest) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ImportResponse_Manifest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Manifest != nil {
		size, err := m.Manifest.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
...
func (m *ImportResponse_Model) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ImportResponse_Model) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Model != nil {
		size, err := m.Model.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
...
func (m *ImportResponse_Object) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ImportResponse_Object) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Object != nil {
		size, err := m.Object.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
...
func (m *ImportResponse_Relation) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ImportResponse_Relation) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Relation != nil {
		size, err := m.Relation.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
...
func (m *ImportCounter) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Get != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.Get))
		i--
		dAtA[i] = 0x18
	}
	if m.Recv != 0 {
...
func (m *ImportRequest_Model) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ImportResponse_Manifest) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ImportResponse_Model) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ImportResponse_Object) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ImportResponse_Relation) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ImportCounter) SizeVT() (n int) {
	...
	if m.Get != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.Get))
	}
	if m.Set != 0 {
...
func (m *ImportRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if oneof, ok := m.Msg.(*ImportRequest_Model); ok {
				if err := oneof.Model.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &v4.Manifest{}
				...
				m.Msg = &ImportRequest_Model{Model: v}
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
...
func (m *ImportResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if oneof, ok := m.Msg.(*ImportResponse_Manifest); ok {
				if err := oneof.Manifest.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				...
				m.Msg = &ImportResponse_Manifest{Manifest: v}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			if oneof, ok := m.Msg.(*ImportResponse_Model); ok {
				if err := oneof.Model.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				...
				m.Msg = &ImportResponse_Model{Model: v}
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			if oneof, ok := m.Msg.(*ImportResponse_Object); ok {
				if err := oneof.Object.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				...
				m.Msg = &ImportResponse_Object{Object: v}
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			if oneof, ok := m.Msg.(*ImportResponse_Relation); ok {
				if err := oneof.Relation.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				...
				m.Msg = &ImportResponse_Relation{Relation: v}
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
