...
var (
	filter_Writer_DeleteObject_0 = &utilities.DoubleArray{Encoding: map[string]int{"object": 0, "type": 1, "id": 2}, Base: []int{1, 1, 1, 2, 0, 0}, Check: []int{0, 1, 2, 2, 3, 4}}
)
...
var (
	filter_Writer_DeleteRelation_0 = &utilities.DoubleArray{Encoding: map[string]int{"relation": 0, "object_type": 1, "object_id": 2, "subject_type": 3, "subject_id": 4, "subject_relation": 5}, Base: []int{1, 7, 1, 2, 3, 4, 5, 0, 0, 0, 0, 0, 7, 0}, Check: []int{0, 1, 2, 2, 2, 2, 2, 3, 4, 5, 6, 7, 2, 13}}
)
