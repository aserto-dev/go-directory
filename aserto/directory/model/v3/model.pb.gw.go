...
func RegisterModelHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ModelServer) error {
	...
	mux.Handle("POST", pattern_Model_ListManifests_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/aserto.directory.model.v3.Model/ListManifests", runtime.WithHTTPPathPattern("/aserto.directory.model.v3.Model/ListManifests"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterModelHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ModelClient) error {
	...
	mux.Handle("POST", pattern_Model_ListManifests_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/aserto.directory.model.v3.Model/ListManifests", runtime.WithHTTPPathPattern("/aserto.directory.model.v3.Model/ListManifests"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_Model_ListManifests_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"aserto.directory.model.v3.Model", "ListManifests"}, ""))
)
