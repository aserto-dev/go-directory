...
func request_Model_GetManifest_0(ctx context.Context, marshaler runtime.Marshaler, client ModelClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Model_GetManifest_0(ctx context.Context, marshaler runtime.Marshaler, server ModelServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetManifestRequest
	var metadata runtime.ServerMetadata
...
func local_request_Model_SetManifest_0(ctx context.Context, marshaler runtime.Marshaler, server ModelServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SetManifestRequest
	var metadata runtime.ServerMetadata
...
func RegisterModelHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ModelServer) error {
	...
	mux.Handle("POST", pattern_Model_GetManifest_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/aserto.directory.model.v3.Model/GetManifest", runtime.WithHTTPPathPattern("/aserto.directory.model.v3.Model/GetManifest"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Model_GetManifest_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_Model_GetManifest_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_Model_SetManifest_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/aserto.directory.model.v3.Model/SetManifest", runtime.WithHTTPPathPattern("/aserto.directory.model.v3.Model/SetManifest"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Model_SetManifest_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("POST", pattern_Model_DeleteManifest_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/aserto.directory.model.v3.Model/DeleteManifest", runtime.WithHTTPPathPattern("/aserto.directory.model.v3.Model/DeleteManifest"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterModelHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ModelClient) error {
	...
	mux.Handle("POST", pattern_Model_DeleteManifest_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/aserto.directory.model.v3.Model/DeleteManifest", runtime.WithHTTPPathPattern("/aserto.directory.model.v3.Model/DeleteManifest"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_Model_DeleteManifest_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"aserto.directory.model.v3.Model", "DeleteManifest"}, ""))
)

var (
	forward_Model_GetManifest_0 = runtime.ForwardResponseMessage
